================================================================================
    MICROSOFT 基础类库: 球场管理系统 项目概述
===============================================================================

应用程序向导已为您创建此 球场管理系统 应用程序。此应用程序不仅演示使用 Microsoft 基础类的基本知识，而且可作为编写应用程序的起点。

此文件包含组成 球场管理系统 应用程序的各个文件的内容摘要。
...
res\球场管理系统.ico
    这是用作应用程序图标的图标文件。此图标包括在主要资源文件 球场管理系统.rc 中。
...
球场管理系统Dlg.h，球场管理系统Dlg.cpp - 对话框
    这些文件包含 CMainDlg 类。该类定义应用程序主对话框的行为。该对话框的模板位于 球场管理系统.rc 中，该文件可以在 Microsoft Visual C++ 中进行编辑。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 球场管理系统.pch 的预编译头(PCH)文件和名为 StdAfx.obj 的预编译类型文件。
